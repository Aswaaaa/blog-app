...
public class UserServiceTest {
    ...
    public void testRegister() {
        ...
        SignUpResponse expectedResponse =
                SignUpResponse.builder().name(user.getName()).email(user.getEmail()).build();
    ...
    public void testAuthenticate() {
        LoginRequest request =
                LoginRequest.builder().email("test@test.com").password("TestPassword").build();
        ...
        LoginResponse expectedResponse =
                LoginResponse.builder().token(jwtToken).role(user.getRole()).build();
